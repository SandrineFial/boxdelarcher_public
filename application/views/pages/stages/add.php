...
<div class="card shadow mb-4">
    <div class="card-body">
        <?php echo form_open_multipart('stages/add'); ?>
        ...
        <div class="form-row">
            <div class="col-md-4 mb-3"><?php
                ...
                <div class="input-group mb-3">
                    ...
                    if(isset($stage)) { $nbdate['value']=$stage[0]->date; }
            ...
            <div class="col-md-4 mb-3"><?php
                ...
                <div class="input-group mb-3">
                    ...
                    if(isset($stage)) { $lieu['value']=$stage[0]->lieu; }
                    else {  }
        ...
        <div class="form-row">
            <div class="col-md-4 mb-3"><?php
                ...
                if(isset($stage)) { $sel_tp=$stage[0]->type_id; }
                else { $sel_tp="0"; }
            ...
            <div class="col-md-4 mb-3"><?php
                ...
                if(isset($stage)) { $description['value']=$stage[0]->description; }
                else {  }
        ...
        <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
              <?php
                if(isset($stage) AND $stage[0]->mandat!="") {
                  ?><a href="<?php echo base_url().path_img_stages.$stage[0]->mandat; ?>" target="_blank">
                    <i class="fa fa-file-pdf fa-4x"></i></a><?php
                }
                else {  }
                if(isset($stage)) { echo form_hidden("id",$stage[0]->id); } ?>
            </div>
        </div>
        <?php
