<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h1 class="h3 mb-0 text-gray-900"><i class="fas fa-info-circle text-primary"></i> Contact</h1>
    </div>
    ...
    <div class="card-body">
        ...
        <p><a href="http://fialons-web.fr/" class="siteweb" target="_blank"><i class="fa fa-address-card"></i></a>&nbsp;
            ...
            &nbsp;<a href="https://www.instagram.com/fialon_sandrine/?hl=fr" class="instagram" target="_blank"><i class="fab fa-instagram"></i></a>
    </p>
    </div>
</div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h2 class="h3 mb-0 text-gray-900"><i class="fas fa-file-image text-primary"></i> Crédit</h2>
    </div>

    <div class="card-body">
        <p>Certaines photos et textes proviennent de documents réalisés par la FFTA (Fédération Française de Tir à l'arc), simplifiés pour les besoins du site.</p>
        <p>D'autres photos et textes ont été édités par S. Fialon.</p>
    </div>
</div>
